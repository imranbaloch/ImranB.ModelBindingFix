...
{
    public class FixedNameValueCollectionValueProvider : IValueProvider, IUnvalidatedValueProvider, IEnumerableValueProvider
    {
        ...
        public FixedNameValueCollectionValueProvider(NameValueCollection collection, CultureInfo culture)
            : this(collection, unvalidatedCollection: null, culture: culture)
        {
        }

        public FixedNameValueCollectionValueProvider(NameValueCollection collection, NameValueCollection unvalidatedCollection, CultureInfo culture)
        {
            if (collection == null)
            {
            ...
            _prefixContainer = new Lazy<FixedPrefixContainer>(() => new FixedPrefixContainer(unvalidatedCollection.AllKeys), isThreadSafe: true);
