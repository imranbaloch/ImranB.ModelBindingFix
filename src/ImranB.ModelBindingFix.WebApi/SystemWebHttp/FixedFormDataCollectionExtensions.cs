...
using ImranB.ModelBindingFix.Mvc.Properties;

namespace ImranB.ModelBindingFix.WebApi.SystemWebHttp
{
    public static class FixedFormDataCollectionExtensions
    {
        ...
        internal static IValueProvider GetJQueryValueProvider(this FormDataCollection formData)
        {
            ...
            return new FixedNameValuePairsValueProvider(nvc, CultureInfo.InvariantCulture);
        }

        public static T FixedReadAs<T>(this FormDataCollection formData)
        {
            return (T)FixedReadAs(formData, typeof(T));
        }

        public static object FixedReadAs(this FormDataCollection formData, Type type)
        {
            return FixedReadAs(formData, type, string.Empty, requiredMemberSelector: null, formatterLogger: null);
        }

        public static T FixedReadAs<T>(this FormDataCollection formData, string modelName, IRequiredMemberSelector requiredMemberSelector, IFormatterLogger formatterLogger)
        {
            return (T)FixedReadAs(formData, typeof(T), modelName, requiredMemberSelector, formatterLogger);
        }
        ...
        // Helper for FixedReadAs() to get a ModelBinderProvider to read FormUrl data. 
        ...
        // Helper for FixedReadAs() to get a ModelBindingContext to invoke model binding over FormUrl data. 
        ...
        private static HttpActionContext CreateActionContextForModelBinding(HttpConfiguration config)
        {
            ...
            controllerContext.ControllerDescriptor = new HttpControllerDescriptor{Configuration = config};
